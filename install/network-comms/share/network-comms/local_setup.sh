...
: ${AMENT_CURRENT_PREFIX:="/home/uez2rc/network-comms-project/install/network-comms"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/network-comms/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/network-comms/environment/path.sh"
